...
<body>
	...
	<div id="header">
		<div class="head-view">
			<ul>
				<li><a href="home.php" title="Home"><b>Social Networking Site</b></a></li>
				<!-- <li></li>
				<li></li>
				<li></li>
				<li></li>
	...
	<div id="container">
		...
		<div id="left-nav">
				...
				<div class="clip1">
					<a href="updatephoto.php" title="Change Profile Picture"><img src="<?php echo $row['profile_pic'] ?>">
					</a>
				</div>
...
<?php
	include("includes/database.php");
			$comment=mysqli_query($link, "SELECT * from comments where post_id='$post_id' order by post_id DESC") or die(mysql_error());
...
?>
		 ...
		 <form  method="POST" action="comment.php">			
			<div class="comment-area">
						...
						<?php $image=mysqli_query($link, "select * from user where user_id='$id'")or die(mysql_error());
